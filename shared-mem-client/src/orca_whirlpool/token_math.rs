...
pub fn get_amount_delta_a(
    ...
    let numerator = mul_u256(liquidity, sqrt_price_diff)
        ...
        .ok_or(SharedMemClientErr::MultiplicationOverflow("SharedMemClientErr".to_string()))?;
    ...
    if result > u64::MAX as u128 {
        return Err(SharedMemClientErr::TokenMaxExceeded("SharedMemClientErr".to_string()));
    }
...
pub fn get_next_sqrt_price_from_a_round_up(
    ...
    if price < MIN_SQRT_PRICE_X64 {
        return Err(SharedMemClientErr::TokenMinSubceeded("SharedMemClientErr".to_string()));
...
pub fn get_next_sqrt_price_from_b_round_down(
    ...
    if amount_specified_is_input {
        ...
        sqrt_price
            .checked_add(delta)
            .ok_or(SharedMemClientErr::SqrtPriceOutOfBounds("SharedMemClientErr".to_string()))
    } else {
