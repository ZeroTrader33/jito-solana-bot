...
impl U256 {
    pub fn try_into_u64(self) -> Result<u64, SharedMemClientErr> {
        self.try_into().map_err(|_| SharedMemClientErr::NumberCastError("SharedMemClientErr".to_string()))
    }

    pub fn try_into_u128(self) -> Result<u128, SharedMemClientErr> {
        self.try_into().map_err(|_| SharedMemClientErr::NumberCastError("SharedMemClientErr".to_string()))
    }
